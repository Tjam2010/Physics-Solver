...
public class FFriction {
    ...
    public double run(){
		...
		JLabel x1 = new JLabel("Normal Force");
                JTextField xField2 = new JTextField(5);
		JLabel x2 = new JLabel("Coefficient of Friction");
...
//		panelHolder[0][9].add(xField5);
		...
		N = Double.parseDouble(xField.getText());
                u = Double.parseDouble(xField2.getText());
