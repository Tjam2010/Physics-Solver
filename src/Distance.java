...
public class Distance {
    ...
    public double run(){
		...
		JPanel[][] panelHolder = new JPanel[1][8];
		myPanel.setLayout(new GridLayout(0,8));
		...
		JLabel x2 = new JLabel("Acceleration");
                JTextField xField3 = new JTextField(5);
		JLabel x3 = new JLabel("Time");
...
//		panelHolder[0][9].add(xField5);
		...
		i = Double.parseDouble(xField.getText());
                a = Double.parseDouble(xField2.getText());
                t = Double.parseDouble(xField3.getText());
                j = Double.parseDouble(xField4.getText());
//                j = Double.parseDouble(xField5.getText());
		}
//		System.exit(0);
		return j+i*t+.5*a*t*t;
	}
}
